...
На сайте - https://ept24.ru/ ищем строки типа - data-correct="1" это и есть правильный ответ на вопрос теста :) именно по этому атрибуту и подсчитываются результаты теста.
